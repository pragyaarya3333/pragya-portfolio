...
export default class Details extends LightningElement {
    ...
    get profileImage() {
        return this.detail.image || '/resources/images/profile.png';
    }

    get displayName() {
        return this.detail.name || this.githubProfile.name || this.github.username || '';
    }

    get displayLocation() {
        return this.detail.location || this.githubProfile.location || this.social.location || '';
    }

    get displayBio() {
        return this.detail.bio || this.githubProfile.bio || '';
    }
